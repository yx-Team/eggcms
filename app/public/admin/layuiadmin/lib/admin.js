...
layui.define('view', function(exports) {
  var $ = layui.jquery,
    ...
    admin = {
      ...
      tabsBodyChange(index, options) {
        ...
        admin.tabsBody(index).addClass(SHOW).siblings()
          .removeClass(SHOW);
      ...
      closeThisTabs() {
        ...
        $(TABS_HEADER).eq(admin.tabsPage.index).find('.layui-tab-close')
          .trigger('click');
      },
  ...
  var events = admin.events = {
    ...
    // 刷新
    refresh() {
      let ELEM_IFRAME = '.layadmin-iframe',
      ...
      const iframe = admin.tabsBody(admin.tabsPage.index).find(ELEM_IFRAME);
    ...
    rollPage(type, index) {
      ...
      if (type === 'left') {
        ...
        const prefLeft = -tabsLeft - outerWidth;
        ...
        (function() {
          ...
          if (thisLeft + thisLi.outerWidth() >= outerWidth - tabsLeft) {
            const subLeft = thisLeft + thisLi.outerWidth() - (outerWidth - tabsLeft);
    ...
    // 关闭其它标签页
    closeOtherTabs(type) {
      const TABS_REMOVE = 'LAY-system-pagetabs-remove';
      if (type === 'all') {
        ...
        list.each(function(index1, item1) {
          ...
          listChildren1.each(function(index2, item2) {
            ...
            listChildren2.each(function(index3, item3) {
              ...
              if (matched3) {
                const selected = data3.list[0] ? SIDE_NAV_ITEMD : THIS;
            ...
            if (matched2) {
              const selected = data2.list[0] ? SIDE_NAV_ITEMD : THIS;
          ...
          if (matched1) {
            const selected = data1.list[0] ? SIDE_NAV_ITEMD : THIS;
  ...
  element.on('tabDelete(' + FILTER_TAB_TBAS + ')', function(obj) {
    const othis = $(TABS_HEADER + '.layui-this');
